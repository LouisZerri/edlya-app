...
export function WelcomeCard({ user, stats }: WelcomeCardProps) {
  ...
  return (
    <View className="mx-4 rounded-2xl overflow-hidden">
      <LinearGradient
        colors={isDark ? ['#272063', '#312e81'] : ['#4F46E5', '#6366F1']}
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 1 }}
        style={{ padding: 20 }}
      >
        ...
        <View className="flex-row gap-3" style={{ marginTop: 16 }}>
          ...
          >
            <Text style={{ color: 'rgba(255,255,255,0.8)', fontSize: 14 }}>Logements</Text>
          ...
          <View
            ...
            style={{ backgroundColor: 'rgba(255,255,255,0.2)', paddingHorizontal: 12, paddingVertical: 8 }}
          >
            <Text style={{ color: 'rgba(255,255,255,0.8)', fontSize: 14 }}>EDL total</Text>
        ...
        <View className="flex-row gap-3" style={{ marginTop: 8 }}>
          ...
          >
            <Text style={{ color: 'rgba(255,255,255,0.8)', fontSize: 14 }}>En attente</Text>
          ...
          <View
            ...
            style={{ backgroundColor: 'rgba(255,255,255,0.15)', paddingHorizontal: 12, paddingVertical: 8 }}
          >
            <Text style={{ color: 'rgba(255,255,255,0.8)', fontSize: 14 }}>Signés</Text>
