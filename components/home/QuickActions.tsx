    ...
    <View className="px-4 mt-6">
      ...
      <View className="flex-row gap-3">
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <View className="w-11 h-11 bg-primary-200 dark:bg-primary-700 rounded-xl items-center justify-center mr-3">
        ...
        <TouchableOpacity
          ...
          className="flex-1 bg-amber-100 dark:bg-amber-900/30 rounded-xl p-4 flex-row items-center"
          activeOpacity={0.7}
        >
          <View className="w-11 h-11 bg-amber-200 dark:bg-amber-700 rounded-xl items-center justify-center mr-3">
